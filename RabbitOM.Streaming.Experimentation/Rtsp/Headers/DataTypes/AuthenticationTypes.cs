...
namespace RabbitOM.Streaming.Experimentation.Rtsp.Headers.DataTypes
{
    ...
    public static class AuthenticationTypes
    {
        private readonly static HashSet<string> Md5Algorithms
            = new HashSet<string>(StringComparer.OrdinalIgnoreCase ) { "MD5" , "MD5-sess" };

        private readonly static HashSet<string> Sha1Algorithms
            = new HashSet<string>(StringComparer.OrdinalIgnoreCase ) { "SHA1" , "SHA-1" , "SHA1-sess" , "SHA-1-sess" , "SHA_1" , "SHA_1-sess" , "SHA" , "SHA-sess" };

        private readonly static HashSet<string> Sha256Algorithms
            = new HashSet<string>(StringComparer.OrdinalIgnoreCase ) { "SHA256" , "SHA-256" , "SHA256-sess" , "SHA-256-sess" , "SHA_256" , "SHA_256-sess" , "SHA256" , "SHA256-sess" };

        private readonly static HashSet<string> Sha384Algorithms
            = new HashSet<string>(StringComparer.OrdinalIgnoreCase ) { "SHA384" , "SHA-384" , "SHA384-sess" , "SHA-384-sess" , "SHA_384" , "SHA_384-sess" , "SHA384" , "SHA384-sess" };

        private readonly static HashSet<string> Sha512Algorithms
            = new HashSet<string>(StringComparer.OrdinalIgnoreCase ) { "SHA512" , "SHA-512" , "SHA512-sess" , "SHA-512-sess" , "SHA_512" , "SHA_512-sess" , "SHA512" , "SHA256-sess" };
