...
namespace RabbitOM.Streaming.Experimentation.Rtsp.Headers
{
    internal sealed class RtspHeaderValueValidatorCharSet
    {
        ...
        private RtspHeaderValueValidatorCharSet( IReadOnlyCollection<char> values )
        {
            Values = values;
        }
        ...
        public static RtspHeaderValueValidatorCharSet Letters { get; } = new RtspHeaderValueValidatorCharSet( (DefaultLettersUpperCase + DefaultLettersLowerCase).ToHashSet<char>() );
        ...
        public static RtspHeaderValueValidatorCharSet BasicToken { get; } = new RtspHeaderValueValidatorCharSet( (DefaultLettersLowerCase + DefaultLettersUpperCase + DefaultDigits + DefaultSymbols1 ).ToHashSet<char>() );
    }
}
