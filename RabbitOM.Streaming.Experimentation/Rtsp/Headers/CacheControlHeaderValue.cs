...
namespace RabbitOM.Streaming.Experimentation.Rtsp.Headers
{
    ...
    public sealed class CacheControlHeaderValue
    {
        ...
        // TODO: replace std::map<string,string> _extensions; by a std::list<std::pair<string,string>> _extensions;
        ...
        public static bool TryParse( string input , out CacheControlHeaderValue result )
        {
            result = null;
        ...
        {
            if ( ! HeaderProtocolValidator.IsValid( name ) || ! HeaderProtocolValidator.IsValid( value ) )
            {
                return false;
            }
