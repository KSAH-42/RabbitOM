...
namespace RabbitOM.Streaming.Experimentation.Rtsp.Headers
{
    ...
    public sealed class SessionHeaderValue
    {
        ...
        public static bool TryParse( string input , out SessionHeaderValue result )
        {
            result = null;
            ...
            if ( HeaderParser.TryParse( input , ";" , out string[] tokens ) )
            {
                ...
                var header = new SessionHeaderValue() { Identifier = identifer };
                ...
                if ( HeaderProtocolValidator.IsValidToken( header.Identifier ) )
                {
                    result = header;
                }
            }
