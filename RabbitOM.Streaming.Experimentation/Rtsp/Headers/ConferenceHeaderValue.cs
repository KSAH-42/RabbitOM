...
namespace RabbitOM.Streaming.Experimentation.Rtsp.Headers
{
    ...
    public sealed class ConferenceHeaderValue
    {
        ...
        public static bool TryParse( string input , out ConferenceHeaderValue result )
        {
            result = null;

            if ( HeaderParser.TryParse( input , ";" , out string[] tokens ) )
            {
                var header = new ConferenceHeaderValue();

                foreach ( var token in tokens.Where( HeaderProtocolValidator.IsValidToken ) )
                {                    
                ...
                if ( HeaderProtocolValidator.IsValidToken( header.ConferenceId ) )
                {
                    result = header;
                }
            }
