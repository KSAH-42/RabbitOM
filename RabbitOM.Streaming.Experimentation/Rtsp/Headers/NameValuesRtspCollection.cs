...
{
    public sealed class NameValuesRtspCollection : IEnumerable, IEnumerable<KeyValuePair<string , IEnumerable<string>>>, ICollection, IReadOnlyCollection<KeyValuePair<string,IEnumerable<string>>>
    {
