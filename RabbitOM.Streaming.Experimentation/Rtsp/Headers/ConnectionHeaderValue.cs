...
namespace RabbitOM.Streaming.Experimentation.Rtsp.Headers
{
    ...
    public sealed class ConnectionHeaderValue
    {
        ...
        public static bool TryParse( string input , out ConnectionHeaderValue result )
        {
            result = null;

            if ( HeaderParser.TryParse( input , "," , out string[] tokens ) )
            {
                var header = new ConnectionHeaderValue();
