...
➡️ The full rtp layer (rtp sequencer, etc...) which already exists, will be added, for the next version. RTP packet is actually accessible in the form as class and raw bytes array. It will be modified after new client implementation.
