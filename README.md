...
A .net assemblies which can be used for receiving raw audio/video streams. After recfactoring the clients, I will add the rtp layers which already exists, but i need to do something before to publish it.
