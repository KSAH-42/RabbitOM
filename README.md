...
If you familliar we ASP.Net Web API, even if the ASP.Net framework hidden the details and support more schemes than the RTSP protocols, here it'is excatly the same headers, etc... 
