...
First of all, it it's not due to the HIK cam. VLC used an external open source rtsp library, and this library doesn't support all authentication schemes/algs provided by this camera.
