...
namespace RabbitOM.Streaming.Experimentation.Tests.Rtsp.Headers
{
    ...
    public class BandwithRtspHeaderTest
    {
        ...
        {
            Assert.IsTrue( BandwidthRtspHeader.TryParse( input , out var header ) );
        ...
        {
            Assert.IsFalse( BandwidthRtspHeader.TryParse( input , out var header ) );
        ...
        {
            var header = new BandwidthRtspHeader();
