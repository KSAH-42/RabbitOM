...
namespace RabbitOM.Streaming.Experimentation.Tests.Rtsp.Headers
{
    ...
    [TestFixture]
    public class BandwithRtspHeaderTest
    {
        [TestCase( "0" , 0 )]
        [TestCase( "1" , 1 )]
        [TestCase( "2" , 2 )]
        ...
        {
            Assert.IsTrue( BandwithRtspHeaderValue.TryParse( input , out var header ) );
        ...
        {
            Assert.IsFalse( BandwithRtspHeaderValue.TryParse( input , out var header ) );
        ...
        {
            var header = new BandwithRtspHeaderValue();
