...
namespace RabbitOM.Streaming.Experimentation.Tests.Rtsp.Headers
{
    ...
    [TestFixture]
    public class ScaleRtspHeaderValueTest
    {
        [TestCase( "0" , 0 )]
        [TestCase( "1" , 1 )]
        [TestCase( "2" , 2 )]
        ...
        {
            Assert.IsTrue( ScaleRtspHeaderValue.TryParse( input , out var header ) );
        ...
        {
            Assert.IsFalse( ScaleRtspHeaderValue.TryParse( input , out var header ) );
        ...
        {
            var header = new ScaleRtspHeaderValue();
