...
namespace RabbitOM.Streaming.Experimentation.Tests.Rtsp.Headers
{
    ...
    [TestFixture]
    public class BandwithRtspHeaderValueTest
    {
        [TestCase( "0" , 0 )]
        [TestCase( "1" , 1 )]
        [TestCase( "2" , 2 )]
        ...
        {
            Assert.IsTrue( BandwidthRtspHeaderValue.TryParse( input , out var header ) );
        ...
        {
            Assert.IsFalse( BandwidthRtspHeaderValue.TryParse( input , out var header ) );
        ...
        {
            var header = new BandwidthRtspHeaderValue();
