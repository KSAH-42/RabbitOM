...
{
    [TestFixture]
    public class MaxForwardsRtspHeaderTest
    {
        [TestCase( "0" , 0 )]
        [TestCase( "1" , 1 )]
        [TestCase( "2" , 2 )]
        ...
        {
            Assert.IsTrue( MaxForwardsRtspHeader.TryParse( input , out var header ) );
        ...
        {
            Assert.IsFalse( MaxForwardsRtspHeader.TryParse( input , out var header ) );
        ...
        {
            var header = new MaxForwardsRtspHeader();
