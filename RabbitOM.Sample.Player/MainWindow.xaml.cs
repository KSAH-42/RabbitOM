...
namespace RabbitOM.Sample.Client.Player
{
    ...
    // This is not a clean code here if we respect wpf, and others things, it's juste a demo, it must be refactored
    // there is a base line here, but the rigth architecture is to write a graph and setup it using a builder
