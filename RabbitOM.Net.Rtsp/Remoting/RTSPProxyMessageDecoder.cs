...
namespace RabbitOM.Net.Rtsp.Remoting
{
    ...
    /// </summary>
    public sealed class RTSPProxyMessageDecoder
    {
        ...
        /// Constructor
        /// </summary>
        public RTSPProxyMessageDecoder()
            : this( short.MaxValue )
        {
        }
        ...
        public RTSPProxyMessageDecoder( long limit )
        {
            if ( limit <= 0 )
            {
        ...
        public bool CompareValueString( string value , bool ignoreCase )
        {
            lock ( _lock )
			{
                return string.Compare(_valueString, value, ignoreCase) == 0;
            }
        }
