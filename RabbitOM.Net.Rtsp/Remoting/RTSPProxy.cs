...
namespace RabbitOM.Net.Rtsp.Remoting
{
    ...
    public sealed class RTSPProxy : IDisposable
    {
        ...
        /// </summary>
        public event EventHandler<RTSPConnectionDataReceivedEventArgs>          DataReceived          = null;
            ...
            try
            {
                lock ( _lock )
                {
                    ...
                    using ( var scope = new RTSPDisposeScope( () => _socket.Close() ) )
                    {
                        ...
                        ConfigureTimeouts(TimeSpan.FromSeconds(15));
        ...
        /// </summary>
        /// <param name="e">the event args</param>
        public void DispatchEvent( RTSPConnectionDataReceivedEventArgs e )
        {
        ...
        /// </summary>
        /// <param name="e"></param>
        private void OnDataReceived( RTSPConnectionDataReceivedEventArgs e )
        {
            RTSPEventInvoker.RaiseEvent<RTSPConnectionDataReceivedEventArgs>( this , e , DataReceived );
        }
        ...
        private void OnDispatchEvent( EventArgs e )
        {
            switch ( e )
            {
                case RTSPConnectionDataReceivedEventArgs eventArgs:
