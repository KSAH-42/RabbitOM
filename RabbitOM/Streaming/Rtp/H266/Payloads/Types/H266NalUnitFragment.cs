...
namespace RabbitOM.Streaming.Rtp.H266.Payloads.Types
{
    public struct H266NalUnitFragment
    {
        ...
        public static bool IsStartPacket( H266NalUnitFragment nalu )
        {
            return nalu.StartBit && ! nalu.StopBit;
        }

        public static bool IsStopPacket( H266NalUnitFragment nalu )
        {
            return ! nalu.StartBit && nalu.StopBit;
        }

        public static bool IsDataPacket( H266NalUnitFragment nalu )
        {
            return ! nalu.StartBit && ! nalu.StopBit;
        }
        ...
        public static bool TryParse( ArraySegment<byte> buffer , bool donl , out H266NalUnitFragment result )
        {
            result = default;
        ...
        public static int ReContructHeader( ArraySegment<byte> buffer )
        {
            if ( buffer.Array == null || buffer.Count < 3 )
            {
                return 0;
