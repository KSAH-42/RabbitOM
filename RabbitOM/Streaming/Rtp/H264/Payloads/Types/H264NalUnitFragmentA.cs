...
namespace RabbitOM.Streaming.Rtp.H264.Payloads.Types
{
    public struct H264NalUnitFragmentA
    {
        ...
        public static bool IsStartPacket( H264NalUnitFragmentA nalUnit )
            => nalUnit.StartBit && ! nalUnit.StopBit;

        public static bool IsStopPacket( H264NalUnitFragmentA nalUnit )
            => ! nalUnit.StartBit && nalUnit.StopBit;

        public static bool IsDataPacket( H264NalUnitFragmentA nalUnit )
            => ! nalUnit.StartBit && ! nalUnit.StopBit;
        ...
        public static bool TryParse( ArraySegment<byte> buffer , out H264NalUnitFragmentA result )
        {
            result = default;
        ...
        public static byte ReConstructHeader( ArraySegment<byte> buffer )
        {
            if ( buffer.Count < 2 )
            {
