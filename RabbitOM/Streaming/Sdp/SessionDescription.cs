...
namespace RabbitOM.Streaming.Sdp
{
    ...
    public sealed class SessionDescription
    {
        ...
        {
            Validate(SessionDescriptionValidator.DefaultValidator);
        }
        ...
        public void Validate(SessionDescriptionValidator validator)
        {
            if (validator == null)
            {
        ...
        {
            return TryValidate(SessionDescriptionValidator.DefaultValidator);
        }
        ...
        /// <param name="validator">the validator</param>
        /// <returns>returns true for a success, otherwise false</returns>
        public bool TryValidate(SessionDescriptionValidator validator)
        {
        ...
        {
            return SessionDescriptionSerializer.Serialize( this );
        }
        ...
        public static SessionDescription Parse(string value)
        {
            if (value == null)
            {
            ...
            return SessionDescriptionSerializer.Deserialize(value) ?? throw new FormatException();
        }
        ...
        /// <returns>returns true for a success, otherwise false</returns>
        public static bool TryParse(string value, out SessionDescription result)
        {
            result = null;
            ...
            try
            {
                result = SessionDescriptionSerializer.Deserialize(value);
        ...
        /// <returns>returns true for a success, otherwise false.</returns>
        /// <exception cref="ArgumentNullException"/>
        public static BaseFieldCollection EnumerateFields( SessionDescription descriptor )
        {
            if ( descriptor == null )
            {
