...
namespace RabbitOM.Streaming.Sdp
{
    ...
    public static class SessionDescriptionExtensions
    {
        ...
        public static string SearchVideoTrackUri( this SessionDescription descriptor )
        {
        ...
        public static IEnumerable<MediaTrack> SelectVideoMediaTracks( this SessionDescription descriptor )
        {
        ...
        /// <param name="descriptor">the descriptor</param>
        /// <returns>retruns a uri value</returns>
        public static string SearchAudioTrackUri( this SessionDescription descriptor )
        {
        ...
        /// <param name="descriptor">the descriptor</param>
        /// <returns>retruns a collection of media track</returns>
        public static IEnumerable<MediaTrack> SelectAudioMediaTracks( this SessionDescription descriptor )
        {
        ...
        /// <param name="descriptor">the descriptor</param>
        /// <returns>retruns a uri value</returns>
        public static string SearchApplicationTrackUri( this SessionDescription descriptor )
        {
        ...
        /// <param name="descriptor">the descriptor</param>
        /// <returns>retruns a collection of media track</returns>
        public static IEnumerable<MediaTrack> SelectApplicationTrackUri( this SessionDescription descriptor )
        {
        ...
        private static IEnumerable<MediaTrack> SelectMediaTracks( this SessionDescription descriptor , Func<MediaDescriptionField , bool> predicate )
        {
            if ( descriptor == null )
            {
