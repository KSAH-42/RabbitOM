...
namespace RabbitOM.Streaming.Rtsp
{
    ...
    public partial class RtspConcurrentQueue<TElement> : IEnumerable , IEnumerable<TElement> , ICollection, IReadOnlyCollection<TElement>
        where TElement : class
    {
        ...
        public RtspConcurrentQueue( int capacity )
        {
            if ( capacity <= 0 )
            {
        ...
        public static bool Wait( RtspConcurrentQueue<TElement> queue )
        {
            if ( queue == null )
            {
        ...
        /// <returns>returns true for a success, otherwise false.</returns>
        /// <exception cref="ArgumentNullException"/>
        public static bool Wait( RtspConcurrentQueue<TElement> queue , WaitHandle cancellationHandle )
        {
            if ( queue == null )
            {
                throw new ArgumentNullException( nameof( queue ) );
        ...
        /// <returns>returns true for a success, otherwise false.</returns>
        /// <exception cref="ArgumentNullException"/>
        public static bool Wait( RtspConcurrentQueue<TElement> queue , TimeSpan timeout )
        {
            if ( queue == null )
            {
                throw new ArgumentNullException( nameof( queue ) );
        ...
        /// <returns>returns true for a success, otherwise false.</returns>
        /// <exception cref="ArgumentNullException"/>
        public static bool Wait(RtspConcurrentQueue<TElement> queue, TimeSpan timeout, WaitHandle cancellationHandle )
        {
            if (queue == null)
            {
                throw new ArgumentNullException(nameof(queue));
