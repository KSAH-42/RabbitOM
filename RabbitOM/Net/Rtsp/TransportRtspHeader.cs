...
namespace RabbitOM.Net.Rtsp
{
    ...
    public sealed class TransportRtspHeader : RtspHeader
    {
        ...
        public static TransportRtspHeader NewInterleavedTransportHeader()
        {
        ...
        /// <returns>returns an instance</returns>
        public static TransportRtspHeader NewInterleavedTransportHeader( int port )
        {
            return new TransportRtspHeader()
            {
        ...
        /// <param name="port">the port number</param>
        /// <returns>returns an instance</returns>
        public static TransportRtspHeader NewUnicastUdpTransportHeader( int port )
        {
            return new TransportRtspHeader()
            {
                TransmissionType = RtspTransmissionType.Unicast ,
        ...
        /// <returns>returns an instance</returns>
        public static TransportRtspHeader NewMulticastUdpTransportHeader( string ipAddress , int port )
        {
        ...
        /// <returns>returns an instance</returns>
        public static TransportRtspHeader NewMulticastUdpTransportHeader( string ipAddress , int port , byte ttl )
        {
        ...
        /// <returns>returns an instance</returns>
        public static TransportRtspHeader NewMulticastUdpTransportHeader( string ipAddress , int port , byte ttl , string mode )
        {
            return new TransportRtspHeader()
            {
        ...
        public static bool TryParse( string value , out TransportRtspHeader result )
        {
            ...
            using ( var reader = new RtspHeaderReader( parser.GetParsedHeaders() ) )
            {
                ...
                result = new TransportRtspHeader();
