...
namespace RabbitOM.Net.Rtsp
{
    ...
    public sealed class AuthorizationRtspHeader : RtspHeader
    {
        ...
        /// <param name="result">the output result</param>
        /// <returns>returns true for a success, otherwise false.</returns>
        private static bool TryParseAsBasic( string value , out AuthorizationRtspHeader result )
        {
            result = null;
        ...
        /// <param name="result">the output result</param>
        /// <returns>returns true for a success, otherwise false.</returns>
        private static bool TryParseAsDigest( IEnumerable<string> headers , out AuthorizationRtspHeader result )
        {
            result = null;
