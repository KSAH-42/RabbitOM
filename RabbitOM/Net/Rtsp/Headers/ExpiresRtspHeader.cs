...
namespace RabbitOM.Net.Rtsp
{
    ...
    /// </summary>
    public sealed class ExpiresRtspHeader : RtspHeader , IRtspHeaderValue<DateTime>
    {
        ...
        public ExpiresRtspHeader( DateTime value )
        {
            Value = value;
        }
        ...
        public static bool TryParse( string value , out ExpiresRtspHeader result )
        {
            ...
            result = new ExpiresRtspHeader( RtspDataConverter.ConvertToDateTimeAsGMT( value ) );
