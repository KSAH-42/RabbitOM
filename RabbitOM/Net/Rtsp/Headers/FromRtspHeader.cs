...
namespace RabbitOM.Net.Rtsp
{
    ...
    /// </summary>
    public sealed class FromRtspHeader : RtspHeader , IRtspHeaderValue<string>
    {
        ...
        public FromRtspHeader( string value )
        {
            Value = value;
        }
        ...
        public static bool TryParse( string value , out FromRtspHeader result )
        {
            ...
            result = new FromRtspHeader( value );
