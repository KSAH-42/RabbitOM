...
namespace RabbitOM.Net.Rtsp.Headers
{
    ...
    public sealed class RtpInfoRtspHeader : RtspHeader
    {
        ...
        public RtpInfoRtspHeader( string url )
            : this( url , 0 )
        {
        }
        ...
        public RtpInfoRtspHeader( string url , long sequence )
            : this( url , sequence , 0 )
        {
        }
        ...
        public RtpInfoRtspHeader( string url , long sequence , long rtpTime )
        {
            Url      = url;
            Sequence = sequence;
            RtpTime  = rtpTime;
