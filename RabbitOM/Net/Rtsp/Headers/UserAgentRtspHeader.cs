...
namespace RabbitOM.Net.Rtsp
{
    ...
    public sealed class UserAgentRtspHeader : RtspHeader
    {
        ...
        public UserAgentRtspHeader( string product )
        ...
        public UserAgentRtspHeader( string product , string version )
        ...
        public UserAgentRtspHeader( string product , string version , string comments )
        {
            Product  = product;
            Version  = version;
            Comments = comments;
