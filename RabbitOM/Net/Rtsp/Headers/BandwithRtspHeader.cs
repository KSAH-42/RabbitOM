...
namespace RabbitOM.Net.Rtsp.Headers
{
    ...
    /// </summary>
    public sealed class BandwithRtspHeader : RtspHeader , IRtspHeaderValue<long>
    {
		...
		public BandwithRtspHeader( long value )
		{
            Value = value;
		}
        ...
        public static bool TryParse( string value , out BandwithRtspHeader result )
        {
            ...
            result = new BandwithRtspHeader( RtspDataConverter.ConvertToLong( value ) );
