...
namespace RabbitOM.Net.Rtsp.Headers
{
    ...
    /// </summary>
    public sealed class ViaRtspHeader : RtspHeader, IRtspHeaderValue<string>
    {
        ...
        public ViaRtspHeader( string value )
        {
            Value = value;
        }
        ...
        public static bool TryParse( string value , out ViaRtspHeader result )
        {
            ...
            result = new ViaRtspHeader( value );
