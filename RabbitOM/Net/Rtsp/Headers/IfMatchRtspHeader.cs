...
namespace RabbitOM.Net.Rtsp.Headers
{
    ...
    /// </summary>
    public sealed class IfMatchRtspHeader : RtspHeader, IRtspHeaderValue<string>
    {
        ...
        public IfMatchRtspHeader( string value )
        {
            Value = value;
        }
        ...
        public static bool TryParse( string value , out IfMatchRtspHeader result )
        {
            ...
            result = new IfMatchRtspHeader( value );
