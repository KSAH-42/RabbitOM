...
namespace RabbitOM.Net.Rtsp.Headers
{
    ...
    /// </summary>
    public sealed class AcceptLanguageRtspHeader : RtspHeader, IRtspHeaderValue<string>
    {
        ...
        /// </summary>
		public AcceptLanguageRtspHeader()
		{
		...
		public AcceptLanguageRtspHeader( string value )
		{
            Value = value;
		}
        ...
        public static bool TryParse( string value , out AcceptLanguageRtspHeader result )
        {
            ...
            result = new AcceptLanguageRtspHeader( value );
