...
namespace RabbitOM.Net.Rtsp
{
    ...
    /// </summary>
    public sealed class RetryAfterRtspHeader : RtspHeader, IRtspHeaderValue<string>
    {
        ...
        public RetryAfterRtspHeader( string value )
        {
            Value = value;
        }
        ...
        public static bool TryParse( string value , out RetryAfterRtspHeader result )
        {
            ...
            result = new RetryAfterRtspHeader()
            {
                Value = value
            };
