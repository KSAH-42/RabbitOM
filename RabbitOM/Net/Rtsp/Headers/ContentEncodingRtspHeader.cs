...
namespace RabbitOM.Net.Rtsp.Headers
{
    ...
    /// </summary>
    public sealed class ContentEncodingRtspHeader : RtspHeader , IRtspHeaderValue<string>
    {
        ...
        /// </summary>
		public ContentEncodingRtspHeader()
		{
		}
		...
		public ContentEncodingRtspHeader( string value )
		{
            Value = value;
		}
        ...
        public static bool TryParse( string value , out ContentEncodingRtspHeader result )
        {
            ...
            result = new ContentEncodingRtspHeader( value );
