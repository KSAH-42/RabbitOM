...
namespace RabbitOM.Net.Rtsp.Headers
{
    ...
    /// </summary>
    public sealed class ContentTypeRtspHeader : RtspHeader, IRtspHeaderValue<string>
    {
		...
		public ContentTypeRtspHeader( string value )
		{
            Value = value;
		}
        ...
        public static bool TryParse( string value , out ContentTypeRtspHeader result )
        {
            ...
            result = new ContentTypeRtspHeader( value );
