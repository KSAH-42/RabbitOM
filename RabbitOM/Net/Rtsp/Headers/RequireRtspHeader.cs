...
namespace RabbitOM.Net.Rtsp
{
    ...
    /// </summary>
    public sealed class RequireRtspHeader : RtspHeader, IRtspHeaderValue<string>
    {
        ...
        public RequireRtspHeader( string value )
        {
            Value = value;
        }
        ...
        public static bool TryParse( string value , out RequireRtspHeader result )
        {
            ...
            result = new RequireRtspHeader( value );
