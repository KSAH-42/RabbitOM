...
namespace RabbitOM.Net.Rtsp.Headers
{
    ...
    /// </summary>
    public sealed class ProxyRequireRtspHeader : RtspHeader , IRtspHeaderValue<string>
    {
        ...
        public ProxyRequireRtspHeader( string value )
        {
            Value = value;
        }
        ...
        public static bool TryParse( string value , out ProxyRequireRtspHeader result )
        {
            ...
            result = new ProxyRequireRtspHeader( value );
