...
namespace RabbitOM.Net.Rtsp.Headers
{
    ...
    /// </summary>
    public sealed class ConnectionRtspHeader : RtspHeader , IRtspHeaderValue<string>
    {
		...
		public ConnectionRtspHeader( string value )
		{
            Value = value;
		}
        ...
        public static bool TryParse( string value , out ConnectionRtspHeader result )
        {
            ...
            result = new ConnectionRtspHeader( value );
