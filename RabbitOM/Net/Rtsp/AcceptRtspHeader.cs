...
namespace RabbitOM.Net.Rtsp
{
    ...
    public sealed class AcceptRtspHeader : RtspHeader
    {
        ...
        public AcceptRtspHeader( string mime )
        {
            AddMime( mime );
        }
        ...
        /// </summary>
        /// <param name="mime">the mime</param>
        public static AcceptRtspHeader NewAcceptHeader( string mime )
        {
            AcceptRtspHeader header = new AcceptRtspHeader();
