...
namespace RabbitOM.Streaming.Net.Rtcp
{
    ...
    public sealed class ReportBlock
    {
        ...
        public ReportBlock( uint synchronizationSource , byte fractionLost , uint cummulativePacketsLost , uint extendedHighestSequence , uint interArrivalJitter , uint lastSRTimestamp , uint delaySinceLastSR )
        {
        ...
        public static bool TryParse( in ArraySegment<byte> buffer , out ReportBlock result )
        {
            result = default;
