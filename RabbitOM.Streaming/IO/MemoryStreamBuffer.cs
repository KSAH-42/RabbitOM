...
namespace RabbitOM.Streaming.IO
{
    ...
    public sealed class MemoryStreamBuffer : Stream
    {
        ...
        /// Gets the position
        /// </summary>
        public override long Position { get => _stream.Position; set => _stream.Position = Numeric.Clamp( value , 0 , _stream.Length ); }
        ...
        { 
            _stream.Position = Numeric.Clamp( value , 0 , _stream.Length );
        }
