...
namespace RabbitOM.Streaming.Collections
{
    ...
    public partial class ConcurrentQueue<TElement> : IEnumerable , IEnumerable<TElement> , ICollection, IReadOnlyCollection<TElement>
        where TElement : class
    {
        ...
        public static bool Wait( ConcurrentQueue<TElement> queue )
        {
            if ( queue == null )
            {
        ...
        /// <returns>returns true for a success, otherwise false.</returns>
        /// <exception cref="ArgumentNullException"/>
        public static bool Wait( ConcurrentQueue<TElement> queue , WaitHandle cancellationHandle )
        {
            if ( queue == null )
            {
                throw new ArgumentNullException( nameof( queue ) );
        ...
        /// <returns>returns true for a success, otherwise false.</returns>
        /// <exception cref="ArgumentNullException"/>
        public static bool Wait( ConcurrentQueue<TElement> queue , TimeSpan timeout )
        {
            if ( queue == null )
            {
                throw new ArgumentNullException( nameof( queue ) );
        ...
        /// <returns>returns true for a success, otherwise false.</returns>
        /// <exception cref="ArgumentNullException"/>
        public static bool Wait(ConcurrentQueue<TElement> queue, TimeSpan timeout, WaitHandle cancellationHandle )
        {
            if (queue == null)
            {
                throw new ArgumentNullException(nameof(queue));
