...
namespace RabbitOM.Net.Sdp.Serialization.Formatters
{
	...
	public static class FormatAttributeValueFormatter
	{
		...
		public static string Format(FormatAttributeValue field, string format, IFormatProvider formatProvider)
		{
			if (field == null)
			{
				return string.Empty;
		...
		public static bool TryFrom(string value, out FormatAttributeValue result)
		{
			result = null;
