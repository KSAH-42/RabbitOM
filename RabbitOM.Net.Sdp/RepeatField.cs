...
namespace RabbitOM.Net.Sdp
{
	...
	/// </summary>
	public sealed class RepeatField : BaseField<RepeatField>
	{
		/// <summary>
		...
		{
			return RepeatFieldFormatter.FormatAsSdp(this);
		}
		...
		public static RepeatField Parse(string value)
		{
			...
			return RepeatFieldFormatter.TryFrom(value, out RepeatField result) ? result : throw new FormatException();
		}
