...
namespace RabbitOM.Net.Sdp
{
	...
	{
		private readonly FieldCollectionInternal<MediaDescriptionField> _collection = new FieldCollectionInternal<MediaDescriptionField>();
		...
		public override MediaDescriptionField this[int index]
		{
		...
		/// </summary>
		public override void Add(MediaDescriptionField field)
		{
		...
		public override void AddRange(IEnumerable<MediaDescriptionField> fields)
		{
		...
		public override bool Contains(MediaDescriptionField field)
		{
		...
		/// <param name="array">the target array</param>
		/// <param name="index">the start index to begin the copy</param>
		public override void CopyTo(MediaDescriptionField[] array, int arrayIndex)
		{
		...
		public override bool Remove(MediaDescriptionField field)
		{
		...
		public override int RemoveAll(IEnumerable<MediaDescriptionField> fields)
		{
		...
		/// <returns>returns the number of fields removed</returns>
		public override int RemoveAll(Predicate<MediaDescriptionField> predicate)
		{
		...
		public override IEnumerator<MediaDescriptionField> GetEnumerator()
		{
		...
		/// <param name="index">the index</param>
		/// <returns>returns an instance</returns>
		public override MediaDescriptionField GetAt(int index)
		{
		...
		public override MediaDescriptionField FindAt(int index)
		{
		...
		public override IEnumerable<MediaDescriptionField> FindAll(Predicate<MediaDescriptionField> predicate)
		{
		...
		/// <param name="field">the field</param>
		/// <returns>returns true for a success, otherwise false</returns>
		public override bool TryAdd(MediaDescriptionField field)
		{
		...
		/// <returns>returns true for a success, otherwise false</returns>
		public override bool TryAddRange(IEnumerable<MediaDescriptionField> fields)
		{
		...
		/// <returns>returns true for a success, otherwise false</returns>
		public override bool TryAddRange(IEnumerable<MediaDescriptionField> fields, out int result)
		{
		...
		/// <returns>returns true for a success, otherwise false</returns>
		public override bool TryGetAt(int index, out MediaDescriptionField result)
		{
